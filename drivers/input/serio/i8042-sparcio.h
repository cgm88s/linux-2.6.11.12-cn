...
#define I8042_COMMAND_REG	(kbd_iobase + 0x64UL)	// I8042ÃüÁî¶Ë¿Ú 0x64
#define I8042_DATA_REG		(kbd_iobase + 0x60UL)	// I8042Êý×Ö¶Ë¿Ú 0x60

static inline int i8042_read_data(void)	//´ÓÊý×Ö¶Ë¿Ú¶ÁÊý×Ö
{
	return readb(kbd_iobase + 0x60UL);
}

static inline int i8042_read_status(void)	//´ÓÃüÁî¶Ë¿Ú¶Á×´Ì¬
{
	return readb(kbd_iobase + 0x64UL);
}

static inline void i8042_write_data(int val) //ÍùÊý×Ö¶Ë¿ÚÐ´Êý×Ö
{
	writeb(val, kbd_iobase + 0x60UL);
}

static inline void i8042_write_command(int val) //ÍùÃüÁî¶Ë¿ÚÐ´ÃüÁî
{
