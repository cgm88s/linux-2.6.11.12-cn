...
int __init i8042_init(void)
{
	...
	i8042_aux_values.irq = I8042_AUX_IRQ; // i8042_aux_irq  键盘对应的中断
	i8042_kbd_values.irq = I8042_KBD_IRQ; //i8042_kbd_irq  鼠标对应的中断
	...
	if (!i8042_noaux && !i8042_check_aux(&i8042_aux_values)) {	// 建立aux鼠标通道，建立鼠标端口
	...
	i8042_kbd_port = i8042_allocate_kbd_port(); //建立kbd键盘通道
	if (i8042_kbd_port)
		i8042_port_register(i8042_kbd_port);	//注册键盘端口
