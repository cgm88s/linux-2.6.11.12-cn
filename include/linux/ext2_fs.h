...
/*
 * Special inode numbers，ext2/ext3/ext4的特用保留的inode编号
 */
#define	EXT2_BAD_INO		 	1	/* Bad blocks inode 坏块inode编号*/
#define EXT2_ROOT_INO		 	2	/* Root inode 根目录inode编号*/
...
{
	return sb->s_fs_info;	 ext2_sb_info
}
#else
...
#endif
#define	EXT2_ADDR_PER_BLOCK(s)		(EXT2_BLOCK_SIZE(s) / sizeof (__u32))	// 块大小/4， 一个块可以存的整数个数
#ifdef __KERNEL__
