...
struct rpc_xprt {
	 ...
	 */
	struct work_struct	sock_connect;  xprt_socket_connect
	unsigned short		port;
	/*
	 * Disconnection of idle sockets
	 */
	struct work_struct	task_cleanup;  xprt_socket_autoclose
	struct timer_list	timer;        xprt_init_autodisconnect
