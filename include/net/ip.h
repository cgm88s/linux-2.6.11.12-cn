...
DECLARE_SNMP_STAT(struct ipstats_mib, ip_statistics); struct ipstats_mib *ip_statistics[2];
/**
 * 更新IP统计计数。
 ...
 * 用在中断环境中。
 */
#define IP_INC_STATS_BH(field)		SNMP_INC_STATS_BH(ip_statistics, field)		// ip_statistics[0] 中断环境
/**
 * 更新IP统计计数。
 * 用在中断环境外。
 */
#define IP_INC_STATS_USER(field) 	SNMP_INC_STATS_USER(ip_statistics, field)  //ip_statistics[1]  非中断环境
